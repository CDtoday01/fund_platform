...
from .views import SwitchRoleView, ETFDefaultsView, ETFListView, ETFTypeListAPIView, CreateETFView, CheckNameExistsView, DeleteETFView, ProgressingETFView, ETFDetailView, UserETFsView, JoinETFView, LeaveETFView
