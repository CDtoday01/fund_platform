...
const ETFDetail = () => {
    ...
    return (
        <div>
            ...
            <p>公告開始時間：{new Date(etf.announcing_start_date).toLocaleString()}</p>
            <p>公告結束時間：{new Date(etf.announcing_end_date).toLocaleString()}</p>
            <p>公告時長：{etf.announcing_duration} 日</p>
